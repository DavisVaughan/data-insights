...
the [`unpivotr`](https://cran.r-project.org/web/packages/unpivotr/index.html) package ([GitHub](https://github.com/nacnudus/unpivotr)) to tidy up some Excel cash flow spreadsheets.

_Note:_ A few functions in the `unpivotr` package that are used here have been deprecated. This post runs with `unpivotr` 0.3.1, but I recommend learning about the newest version if you have an interest in the package.
...
If you want to follow along, feel free to fork [this](https://github.com/DavisVaughan/tidying-excel-cashflows-blog-companion) 

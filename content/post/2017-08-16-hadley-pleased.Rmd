...
cat(read_rds("data/2017-08-16-hadley-pleased/archive_html.rds"), sep = "\n")
```
...
head(read_rds("data/2017-08-16-hadley-pleased/links.rds"))
```
...
cat(read_rds("data/2017-08-16-hadley-pleased/blog-data.rds"), sep ="\n")
```
...
read_rds("data/2017-08-16-hadley-pleased/nms.rds")
```
...
blog_data_no_xml <- read_rds("data/2017-08-16-hadley-pleased/blog-data-no-xml.rds")
...
blog_data_cat_tags <- read_rds("data/2017-08-16-hadley-pleased/blog-data-cat-tag.rds")
...
blog_data <- read_rds("data/2017-08-16-hadley-pleased/blog-data-final.rds")
```
